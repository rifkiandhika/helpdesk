...
<div class="wrapper">
      ...
      <!-- <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          ...
          <a href="#" class="dropdown-item">
             Message Start -->
            <!-- <div class="media">
              <img src="<?php echo e(asset('assets/dist/img/user8-128x128.jpg')); ?>" alt="User Avatar" class="img-size-50 img-circle mr-3">
              <div class="media-body">
                <h3 class="dropdown-item-title"> -->
          ...
          <a href="#" class="dropdown-item">
            Message Start
            <div class="media">
              <img src="<?php echo e(asset('assets/dist/img/user3-128x128.jpg')); ?>" alt="User Avatar" class="img-size-50 img-circle mr-3">
              <div class="media-body">
                <h3 class="dropdown-item-title">
                  Nora Silvester
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      <img src="<?php echo e(asset('assets/dist')); ?>" alt="" class="brand-image img-circle elevation-3" style="opacity: .8">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="background SBA.jpg" class="img-circle elevation-2" alt="">
        </div>
        <div class="info">
    ...
    <!-- /.content -->
        ...
        <div class="container-fluid">
            ...
            <div class="col-lg-3 col-6">
                ...
                <div class="inner">
                    <h3><?php echo e($proses); ?><sup style="font-size: 20px"></sup></h3>
...
<?php /**PATH C:\xampp\htdocs\helpdesk1-main\resources\views/Menu/clientlogin.blade.php ENDPATH**/ ?>